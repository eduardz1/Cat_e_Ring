...
\begin{itemize}[label=$-$, noitemsep]
	...
	\begin{itemize}[label=$-$, noitemsep]
		\item {{[}}\textbf{Se}{ }\myuline{cuoco}{ non }\textbf{lavora in }
			  \myuline{turno}{{]} }\myuline{assegnamento}{ è }\textbf{eseguito da }\myuline{cuoco}
	\end{itemize}
	\item {{[}}\textbf{Se}{ }\myuline{quantità}{ è specificato{]} }\myuline{assegnamento.quantità}{ = }\myuline{dosi}
	\item {{[}}\textbf{Se}{ }\myuline{stimaTempo}{ è specificato{]} }\myuline{assegnamento.tempoStimato}{ = }\myuline{stimaTempo}
	\item {{[}}\textbf{Se }\myuline{continuazione}{ è specificato e }\textbf{se }
		  \myuline{continuazione}{ != }\myuline{assegnamento}{]}
		\begin{itemize}[label=$-$, noitemsep]
			\item \myuline{assegnamento}{ è }\textbf{continuazione }{di }\myuline{continuazione}
		\end{itemize}
\end{itemize}
