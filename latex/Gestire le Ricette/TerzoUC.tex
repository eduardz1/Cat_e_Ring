...
\renewcommand{\thesubsection}{\thesection.\alph{subsection}.1} % removes reference of \chapter to avoid "0."
\renewcommand{\thesubsubsection}{\thesubsection.2} % removes reference of \chapter to avoid "0."
