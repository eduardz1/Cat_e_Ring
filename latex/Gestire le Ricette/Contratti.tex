...
\section[aggiungiIngrediente]{\texorpdfstring{aggiungiIngrediente(\myuline{ingrediente}{: Ingrediente, }\myuline{dosi}?: numero, \myuline{unitàDiMisura}?: testo)}}\label{aggiungiIngrediente}
\textbf{Pre-condizioni:}
\begin{itemize}[label=$-$, noitemsep]
	\item {è in corso la definizione di una Procedura }\textit{p}
\end{itemize}
\textbf{Post-condizioni:}
\begin{itemize}[label=$-$, noitemsep]
	\item {è stata creata una istanza }\textit{i}{ di Ingrediente in Procedura che associa }\myuline{ingrediente}{ a }\textit{p}
...
\begin{itemize}[label=$-$, noitemsep]
	\item {è in corso la definizione di una Procedura }\textit{p}
	\item \textit{p}{ è una istanza di Ricetta}
\end{itemize}
\textbf{Post-condizioni:}
\begin{itemize}[label=$-$, noitemsep]
...
\subsection[modificaDettagliProcedura]{\texorpdfstring{modificaDettagliProcedura(\myuline{porzioni?}{: numero, }\myuline{tAttività}{?: LocalTime, }\myuline{tTotale}{?:
...
\subsection[modificaTagAnnotazione]{\texorpdfstring{modificaTagAnnotazione(\myuline{annotazione}: Annotazione, \myuline{descrizione}: testo)}}\label{modificaTagAnnotazione}
\textbf{Pre-condizioni:}
\begin{itemize}[label=$-$, noitemsep]
	\item {è in corso la definizione di una Procedura }\textit{p }
...
\textbf{Post-condizioni:}
\begin{itemize}[label=$-$, noitemsep]
	\item \textit{annotazione.tag}{ = }\myuline{}{descrizione}
\end{itemize}
...
\begingroup
\renewcommand{\thesubsection}{\thesection.d.2}
...
\begingroup
\renewcommand{\thesubsection}{\thesection.d.3}
