...
public class Assignment {
    ...
    public static void saveAllNewAssignments(int summarysheet_id, List<Assignment> assignments) {
        String AssInsert =
                "INSERT INTO catering.assignment (id_summary_sheet, completed, quantity, estimatedTime, id_as_continuation, id_shift, id_cook, id_Procedure) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
        int[] result =
    ...
    public static void saveNewAssignments(int ssId, Assignment as) {
        String InsertAssignment =
                "INSERT INTO catering.assignment (completed, quantity, estimatedTime, id_as_continuation, id_shift, id_cook, id_Procedure) VALUES (?, ?, ?, ?, ?, ?, ?);";
        int[] result =
                PersistenceManager.executeBatchUpdate(
                        InsertAssignment,
                        1,
